...
class Event(models.Model):
    ...
    # Whether this event's autobuilt ligand pose has been merged into the
    # crystal model. The crystal start-model is the APO input, so NOTHING is
    # pre-merged: ingest leaves this null and every event begins a *candidate*.
